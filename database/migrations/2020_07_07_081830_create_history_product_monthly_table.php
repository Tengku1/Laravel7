...
class CreateHistoryProductMonthlyTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('history_product_monthly', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('history_product_monthly');
    }
}
