...
<form action="/market/storeSell" method="post" class="px-0 py-0">
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            ...
            <input type="hidden" name="sellId" value="{{$historySell[0]->id}}">
            <div class="col-md-6 float-left px-1">
    ...
    <div class="card">
                ...
                <div class="col-md-6 float-left">
                    <div class="dropdown float-left mb-2">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            @for ($i = 1; $i <= sizeof($history); $i++) <a href="/market/detail/sell/{{$i}}" class="dropdown-item">{{$i}}</a>
                             @endfor
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-12 table-responsive px-4">
            <table class="mt-3 tableData table table-light">
                ...
                <input type="hidden" name="id" value="{{$item->sellId}}">
