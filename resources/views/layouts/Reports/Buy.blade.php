...
<div class="card">
    ...
    <div class="card-body">
        <div class="col-md-12 table-responsive px-2">
            ...
            <form action="/report/buy/{{$branchSelected[0]}}" method="get" class="p-0 col-md-12 clearfix">
                @else
                <form action="/report/buy/" method="get" class="p-0 col-md-12 clearfix">
                    @endif
                    <div class="col-md-12 float-left mt-1">
                        ...
                        <div class="col-md-6 float-left pr-1 mb-2">
                            ...
                            <div class="col-md-4 float-left pl-1 btn-group">
                                ...
                                <button type="reset" class="btn bg-danger text-white rounded-0 mr-1 float-left">Clear <i
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <div class="dropdown float-left mr-1 mb-1">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            @for ($i = 0; $i < sizeof($branch); $i++) <a href="/report/buy/{{$branch[$i]->slug}}/"
                                class="dropdown-item">
                                {{$branch[$i]->name}}
                                </a>
                                @endfor
