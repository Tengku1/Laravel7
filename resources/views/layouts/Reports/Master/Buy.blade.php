    ...
    <div class="card-body">
        <div class="col-md-12 table-responsive px-2">
            ...
            @if ($branchSelected != null)
                <form action="/report/buy/{{$branchSelected[0]}}{{$data[0]->ReffID}}" method="get" class="p-0 col-md-12 clearfix">
            @else
            <form action="/report/buy/{{$data[0]->ReffID}}" method="get" class="p-0 col-md-12 clearfix">
            @endif
            ...
            <div class="col-md-12 mb-3">
                <a href="{{route('excelReport','buy')}}" target="_blank">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a href="/report/buy/{{$branch[$i]->slug}}/" class="dropdown-item">
                        {{$branch[$i]->name}}
                    </a>
                    @endfor
                </div>
            ...
            <div class="col-md-12 row">
                <table class="mt-3 tableData table table-light px-2 border-bottom border-dark">
                    <tr class="bg-dark text-white">
                        <td colspan="3">Branch : {{$branchSelected == null ? "All Branches" : $branchSelected[0]}}</td>
                    </tr>
                    <tr>
                        <th>Reff ID</th>
                        <th>Qty</th>
