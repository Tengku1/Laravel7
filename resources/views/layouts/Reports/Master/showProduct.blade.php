    ...
    <div class="card-body">
        <div class="col-md-12 px-2">
            ...
            <div class="col-md-12 mb-5">
                <form action="/report/product/{{$data[0]->BranchCode}}/{{$data[0]->ProductID}}/" method="get" class="px-0 py-0">
                    <div class="col-md-12 float-left px-1 mb-2">
                        <div class="col-md-12 float-left mt-1">
                            <div class="col-md-4 float-left pr-1">
                                <div class="col-md-12"><label for="" class="font-weight-bold">From</label></div>

                                <div class="col-md-12">
                                    <input type="date" name="fromDate" id="" class="form-control" value="{{date("Y-m-d")}}">
                                </div>
                            </div>
                            <div class="col-md-6 float-left pr-1">
                                ...
                                <div class="col-md-4 float-left pl-1 btn-group">
                                    <button type="submit"
                                    class="btn bg-info text-white rounded-0 mr-1 float-left">Search <i
                                        class="fa fa-search"></i></button>
                                <button type="clear"
                                    class="btn bg-danger text-white rounded-0 mr-1 float-left">Clear <i
