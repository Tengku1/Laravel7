@extends('layouts.master',['title'=>'Report Detail Sells - Crux'])
    ...
    <div class="card-body">
        <div class="col-md-12 table-responsive px-2">
            ...
            <div class="col-md-12 mb-5">
                <form action="/report/sell/Reff/{{$data[0]->ReffID}}" method="post"
                    class="px-0 py-0">
                    {{ csrf_field() }}
            ...
            <div class="col-md-12 mb-3">
                <div class="col-md-7 px-1 float-left btn-group">
                    <form action="{{route('excelShowReport','sell')}}" class="px-0 py-0" method="post">
                        {{ csrf_field() }}
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            @for ($i = 1; $i <= sizeof($data); $i++) <a
                                href="/report/sell/Reff/{{$data[0]->ReffID}}/paginate/{{$i}}/" class="dropdown-item">
                                {{$i}}
                                </a>
                                @endfor
                        </div>
                ...
                <div class="col-md-3 px-1 py-0 float-right">
                    <form action="/report/sell/Reff/{{$data[0]->ReffID}}" method="get" class="px-0 py-1 input-group">
