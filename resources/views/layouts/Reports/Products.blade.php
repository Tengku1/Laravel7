    ...
    <div class="card-body">
        <div class="col-md-12 table-responsive px-2">
            <div class="col-md-12 row mb-3">
                <form action="/report/product" method="post" class="col-md-12 px-3">
                    {{ csrf_field() }}
            ...
            <div class="col-md-12 mb-3">
                ...
                <div class="col-md-3 px-1 py-0 float-right">
                    <form action="/report/product/search" method="get" class="px-0 py-0 input-group">
            ...
            <div class="col-md-12 row">
                <table class="mt-3 tableData table table-light px-1 border border-dark">
                    <tr class="bg-dark text-white font-weight-bold text-capitalize text-center">
                        <td colspan="5">Total All Price: {{number_format($totalProducts,2)}}</td>
                    </tr>
                    <tr>
                        <th>Product Name</th>
                        <th>Total Price</th>
