    ...
    <div class="card-body">
        <div class="col-md-12 table-responsive px-2">
            <div class="col-md-12 row mb-3">
                <form action="/report/sell" method="post" class="col-md-12 px-3">
                    {{ csrf_field() }}
            ...
            <div class="col-md-12 mb-3">
                <div class="col-md-7 px-1 float-left">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        @for ($i = 1; $i <= sizeof($getSizeData); $i++) <a href="/report/sell/paginate/{{$i}}/"
                            class="dropdown-item"> {{$i}}</a>
                            @endfor
                    </div>
                </div>
                <div class="col-md-3 px-1 py-0 float-right">
                    <form action="/report/sell/search" method="get" class="px-0 py-0 input-group">
            ...
            <div class="col-md-12 row">
                <table class="mt-3 tableData table table-light px-1 border border-dark">
                    <tr class="bg-dark text-white font-weight-bold text-capitalize text-center">
                        <td colspan="5">Total Sell Price : {{number_format($totalSell[0],2)}}</td>
                    </tr>
                    <tr>
                        <th>Reff ID</th>
                        <th>Branch Name</th>
